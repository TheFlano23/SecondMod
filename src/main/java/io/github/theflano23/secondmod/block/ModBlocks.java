package io.github.theflano23.secondmod.block;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> BLACK_OPAL_BLOCK = registerBlock("black_opal_block",
        () -> new Block(BlockBehaviour.Properties.of(Material.METAL) //sets the walk sounds (walking on metal)
                    .strength(6f)
                    .requiresCorrectToolForDrops())); //sets blast resistance/mining speed and that it needs pickaxe to drop
    ...
    public static final RegistryObject<Block> END_STONE_BLACK_OPAL_ORE = registerBlock("end_stone_black_opal_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.of(Material.STONE) //sets the walk sounds (walking on metal)
